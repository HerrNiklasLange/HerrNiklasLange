...
**Visualization & BI Tools:** Power BI, Tableau, Plotly, Matplotlib, Seaborn  
**Platforms & Tools:** Databricks, Agile/Scrum, MS Office Suite, Azure Fundamentals  
**Certifications:** [Data Literacy](https://www.datacamp.com/skill-verification/DL0035394071721), [Data Analyst](https://www.datacamp.com/certificate/DAA0017066872410)  
**Languages:** German (native), English (native)  
**Leadership & Teamwork:** University Hockey Captain, Volleyball Player
...
- Developed data-driven insights to optimize resource allocation in customer support.  
- Processed datasets using Databricks and SQL to deliver actionable reports.

**First Central Insurance – ML Intern (Advanced Machine Learning Team)** *(Jul–Aug 2023)*  
...
- Dean's List 2023/24  
- Coursework: SQL, Python, Java, Software Architecture, Data Mining, ML

**Michigan Technological University – Year Abroad** *(2024–2025)*  
- Dean's List Spring 2025  
- Coursework: Artificial Intelligence, Machine Learning, Data Mining (Python)
